...
public class LittleSearchEngine {
	...
	public void mergeKeywords(HashMap<String,Occurrence> kws) {
		for (String ptr :kws.keySet()){
			if(keywordsIndex.containsKey(ptr)){
				keywordsIndex.get(ptr).add(kws.get(ptr));
				insertLastOccurrence(keywordsIndex.get(ptr));
			} else {
				ArrayList<Occurrence> occurrence = new ArrayList<Occurrence>();
				occurrence.add(kws.get(ptr));
				keywordsIndex.put(ptr,occurrence);
			}
		}
	}
